    ...
    "tecnicas": [
        {
            "id": 1,
            "nome": "Arm Lock",
            "descricao": "Finalização clássica que hiperextende o cutuvelo do adversário.",
            ...
            "destaque": true,
            "data": "20-01-2026",
            "imagem_principal": "public/img/armlock.png",

            "fotos": [
                {"id": 1, "titulo": "Arm Lock pela guarda",  "imagem": "#"},
                {"id": 2, "titulo": "Arm Lock pela montada", "imagem": "#"},
                {"id": 3, "titulo": "Finalização do Arm Lock", "imagem": "#"}
            ]      
        },

        {
            ...
            "destaque": true,
            "data": "15-01-2026",
            "imagem_principal": "public/img/arco-e-flecha.png",

            "fotos": [
                {"id": 1, "titulo": "Pegada da lapela",  "imagem": "#"},
                {"id": 2, "titulo": "Posicionamento das pernas", "imagem": "#"},
                {"id": 3, "titulo": "Finalização do Arco e Flecha", "imagem": "#"}
            ]
        },

        {
            ...
            "conteudo": "A Kimura é uma chave articular que atua no ombro do adversário. A pegada característica envolve o pulso do oponente com uma mão e a própria mão com a outra, formando uma figura de 4. A técnica recebeu o nome do judoca japonês Masahiko Kimura, que a utilizou para vencer Hélio Gracie em 1951. Pode ser aplicado de diversas posições como a guarda fechada, meia-guarda.",
            "categoria": "Finalização",
            "dificuldade": "Iniciante",
            "destaque": false,
            "data": "20-03-2026",
            "imagem_principal": "public/img/Kimura.png",

            "fotos": [
                {"id": 1, "titulo": "Pegada da Kimura",  "imagem": "#"},
                {"id": 2, "titulo": "Kimura pela guarda", "imagem": "#"},
                {"id": 3, "titulo": "Aplicação do kimura", "imagem": "#"}
            ]
        },

        {
            ...
            "destaque": true,
            "data": "25-04-2026",
            "imagem_principa": "public/img/mata-leao.png",
            
            "fotos":[
                {"id": 1, "titulo": "Tomada das costas",  "imagem": "#"},
                {"id": 2, "titulo": "Encaixe do Mata Leão", "imagem": "#"},
                {"id": 3, "titulo": "Finalização do Mata Leão", "imagem": "#"}
            ]
        },

        {
            ...
            "conteudo": "O Triângulo, é um estrangulamento aplicado com as pernas. Uma perna cruza sobre o pescoço do adversário enquanto a outra passa por baixo, prendendo um dos braços do oponente junto ao pescoço. A pressão das coxas sobre as artérias do pescoço causa o estrangulamento. É uma técnica muito versátil, podendo ser aplicada a partir da guarda, da montada e de outras posições.",
            "categoria": "Estrangulamento",
            "dificuldade": "Intermediário",
            "data": "03-05-2026",
            "imagem_principal": "#",
            ...
            "fotos":[
                {"id": 1, "titulo": "Abertura para o triângulo", "imagem": "#"},
                {"id": 2, "titulo": "Encaixe das pernas",  "imagem": "#"},
                {"id": 3, "titulo": "Finalização do triângulo", "imagem": "#"}
            ]
        },

        {
            ...
            "fotos":[
                {"id": 1, "titulo": "Configuração do Omoplata", "imagem": "#"},
                {"id": 2, "titulo": "Rotação do corpo", "imagem": "#"},
                {"id": 3, "titulo": "Pressão no ombro", "imagem": "#"}
            ]
        },

        {
            ...
            "descriçao": "Varredura clássica da guarda fechada para inverter a posição.",
            ...
            "fotos": [
                {"id": 1, "titulo": "Posição inicial da tesoura", "imagem": "#"},
                {"id": 2, "titulo": "Movimento de tesoura", "imagem": "#"},
                {"id": 3, "titulo": "Inversão de posição", "imagem": "#"}
            ]
        },
